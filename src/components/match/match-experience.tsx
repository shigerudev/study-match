...
import { CalendarDays, Check, ChevronLeft, Heart, MapPin, Sparkles, X } from "lucide-react";
...
export function MatchExperience() {
  ...
  if (view === "schedule") return <ScheduleForm onDone={() => setView("scheduled")} />;
